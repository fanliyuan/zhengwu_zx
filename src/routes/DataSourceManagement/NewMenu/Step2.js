...
import { Form, Input, Button, Select, Radio, Row } from 'antd'
...
export default class Step2 extends PureComponent {
  ...
  goBack = () => {
    this.props.dispatch(
      routerRedux.push('/dataSourceManagement/newMenu/one')
    )
  }

  goForward = () => {
    this.props.dispatch(
      routerRedux.push('/dataSourceManagement/newMenu/three')
    )
  }
    ...
    return (
      <Fragment>
        ...
        <div style={{textAlign: 'center'}} >
          <Button size='large' style={{marginRight: 40}} onClick={this.goBack} >上一步</Button>
          <Button size='large' type='primary' style={{marginRight: 40}} onClick={this.goForward} >提交</Button>
        </div>
      </Fragment>
    )
  }
