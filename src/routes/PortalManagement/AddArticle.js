...
export default class AddArticle extends Component {
  ...
  render() {
    ...
    const btnComs = (
      <Fragment>
        <Link to='/portalManagement/publicationManagement' className={styles.fr} ><Button type='primary' >返回</Button></Link>
        <Button type='primary' className={styles.fr} onClick={this.handleSave} >保存</Button>
      </Fragment>
    )
        ...
        <div className='common-layout' >
          ...
          <Form>
            ...
            <Item label='内容' {...formItemLayout} >
              <ReactQuill value={this.state.quillText} modules={quillModules} onChange={this.handleQuillChange} className={styles.quill} />
            </Item>
