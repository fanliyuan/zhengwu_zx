      ...
      <PageHeaderLayout>
        <Card>
          <div className={styles.form}>
            ...
            <Select style={{marginRight:20,width:120}} value={role} onChange={this.selectRoleChange}>
              {selectData1}
            </Select>
            <Select style={{marginRight:20,width:100}} value={status} onChange={this.selectStatusChange}>
              {selectData2}
            </Select>
