...
export default class PlatformOverview extends Component {
  ...
  render() {
    ...
    const fakeData = [ { title: '机构数量', content: 24 }, { title: '节点数量', content: 24 }, { title: '信息资源', content: 199 }, { title: '接入资源', content: 102 }, { title: '数据量', content: '24k·条' }, { title: '文件量', content: '500.03·PB' }, { title: '交换数', content: 102 }, { title: '总交换数', content: 1024 } ]
              ...
              <div>
                <div className={styles.salesRank}>
                  ...
                  <Select className={styles.select1} defaultValue="amount">
                    ...
                    <Select.Option value="amount">按下载量</Select.Option>
                  </Select>
