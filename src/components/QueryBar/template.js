      ...
      <Form className="ant-advanced-search-form" onSubmit={this.handleSearch}>
        <div id="area">
          ...
          <Row type="flex" justify="end">
            ...
            <Col style={{ marginRight: 16 }}>
              <Button type="ghost" size="large" htmlType="reset" onClick={this.handleReset}>
                重置
              </Button>
            </Col>
            <Col style={{ marginRight: 16 }}>
              <Button type="ghost" size="large" onClick={this.handleExport}>
                导出
              </Button>
            </Col>
            <Col style={{ marginRight: 16 }}>
              <Button type="ghost" size="large" onClick={this.handleBack}>
                返回
              </Button>
            </Col>
          </Row>
