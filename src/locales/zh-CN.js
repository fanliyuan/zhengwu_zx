export default {
  ...
  'component.globalHeader.help': '使用文档(暂无)',
  ...
  'menu.form.stepform.stepform': '步骤表单',
  ...
  'app.setting.production.hint':
    ...
    // 自定义部分
  'menu.overview': '系统概览',
  'menu.overview.platformoverview': '概览',
  'menu.overview.logging': '登录日志',
  'menu.overview.systemnotification': '系统通知',
  'menu.overview.noticedetail': '通知详情',
  'menu.audit': '审计管理',
  'menu.audit.logging': '登录审计',
  'menu.audit.operation': '操作审计',
  'menu.infrastructure': '基础设施管理',
  'menu.infrastructure.node': '节点管理',
  'menu.infrastructure.addnode': '新增节点',
  'menu.infrastructure.editnode': '修改节点',
  'menu.infrastructure.pass': '通道管理',
  'menu.infrastructure.editpass': '修改通道',
  'menu.infrastructure.switch': '交换域管理',
  'menu.infrastructure.addswitch': '新增交换域',
  'menu.infrastructure.editswitch': '修改交换域',
  'menu.dataSourceManagement': '政务信息资源目录',
  'menu.dataSourceManagement.sourceManagement': '信息资源管理',
  'menu.dataSourceManagement.openShare': '开放共享',
  'menu.dataSourceManagement.addDirectory': '新建资源',
  'menu.dataSourceManagement.inputDirectory': '导入资源',
  ...
  'menu.dataSourceManagement.resourceConnection': '资源挂接数据',
  'menu.dataSourceManagement.task': '任务',
  'menu.dataPublicManagement': '数据发布管理',
  'menu.dataPublicManagement.dataManager': '数据管理',
  ...
  'menu.portalManagement.carouselManagement': '轮播图管理',
  'menu.portalManagement.addCarousel': '新增轮播图',
  'menu.portalManagement.editCarousel': '修改轮播图',
  'menu.portalManagement.columnPosition': '栏目管理',
  'menu.monitor': '监控告警',
  'menu.monitor.nodeMonitor': '节点监控',
  'menu.monitor.pass': '通道监控',
  'menu.monitor.insert': '接入监控',
  'menu.monitor.task': '交换监控',
  'menu.monitor.pubDetail': '发布监控详情',
  'menu.monitor.subDetail': '订阅监控详情',
  'menu.monitor.warningOption': '告警配置',
  'menu.monitor.warningQuery': '告警查看',
  'menu.monitor.editOption': '告警设置',
  'menu.monitor.addWarningOption': '新增告警配置',
  'menu.monitor.editWarningOption': '编辑告警配置',
  'menu.monitor.node': '监控详情',
  'menu.monitor.insertDetail': '接入源数据监控',
  'menu.statistics': '统计分析',
  'menu.statistics.dataInsert': '数据接入分析',
  'menu.institutionalUserManage': '机构用户管理',
  'menu.institutionalUserManage.institutionalManage': '机构管理',
  'menu.institutionalUserManage.addInstitution': '新建机构',
  'menu.institutionalUserManage.userManage': '用户管理',
  'menu.institutionalUserManage.addUser': '新建用户',
  'menu.institutionalUserManage.editUser': '修改用户',
  'menu.institutionalUserManage.roleLimit': '角色管理',
  'menu.institutionalUserManage.addRole': '新建角色',
  'menu.institutionalUserManage.limitSet': '权限设置',
  'menu.institutionalUserManage.assignRole': '分配角色',
}
