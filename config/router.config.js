    ...
    routes: [
      ...
      // 数据资源管理 dataSourceManagement
      {
        ...
        routes: [
          ...
          {
            name: 'editSourceClassfiy',
            path: 'editSourceClassfiy',
            component: './DataSourceManagement/AddSourceClassfiy',
            hideInMenu: true,
            // authority: ['operator', 'operator-n'],
          },
      ...
      // 数据发布管理 dataPublicManagement
      {
        ...
        routes: [
          ...
          },
          {
            path: 'dbview/:id',
            name: 'dbview',
            component: './DataPublicManagement/DBView',
            authority: ['operator', 'operator-n'],
            hideInMenu: true,
          },
          {
            path: 'fileview/:id',
            name: 'fileview',
            component: './DataPublicManagement/FileView',
            authority: ['operator', 'operator-n'],
            hideInMenu: true,
          },
          {
            path: 'ftpview/:id',
            name: 'ftpview',
            component: './DataPublicManagement/FtpView',
            authority: ['operator', 'operator-n'],
            hideInMenu: true,
          },
          {
